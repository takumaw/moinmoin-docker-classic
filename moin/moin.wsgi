...
"""
    ...
    WSGIDaemonProcess daemonname user=someuser group=somegroup processes=5 threads=10 maximum-requests=1000 umask=0022
...
sys.path.insert(0, '/var/www/moin/data/config')
...
from MoinMoin import log
log.load_config('/var/www/moin/data/config/logging/logfile')
